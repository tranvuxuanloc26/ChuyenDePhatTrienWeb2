...
@section('content')
<form class="bg0 p-t-100 p-b-85" method="post" style="padding-bottom: 0">
    @include('admin.alert')
    @if(count($products) != 0)
...
<form action="/payment" method="POST" style="margin-left: 978px; margin-bottom: 20px; width:285px !important;">
    @csrf
